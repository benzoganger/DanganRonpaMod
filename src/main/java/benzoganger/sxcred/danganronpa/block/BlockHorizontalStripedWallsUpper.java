...
public class BlockHorizontalStripedWallsUpper extends ElementsBenzogangedSxredDanganronpaMod.ModElement {
	@GameRegistry.ObjectHolder("benzoganged_sxred_danganronpa:horizontal_striped_walls_upper")
	public static final Block block = null;
	public BlockHorizontalStripedWallsUpper(ElementsBenzogangedSxredDanganronpaMod instance) {
		super(instance, 5);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("benzoganged_sxred_danganronpa:horizontal_striped_walls_upper", "inventory"));
	}
