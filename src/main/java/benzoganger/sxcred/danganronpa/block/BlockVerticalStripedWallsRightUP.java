...
public class BlockVerticalStripedWallsRightUP extends ElementsBenzogangedSxredDanganronpaMod.ModElement {
	@GameRegistry.ObjectHolder("benzoganged_sxred_danganronpa:vertical_striped_walls_right_up")
	public static final Block block = null;
	public BlockVerticalStripedWallsRightUP(ElementsBenzogangedSxredDanganronpaMod instance) {
		super(instance, 8);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("benzoganged_sxred_danganronpa:vertical_striped_walls_right_up", "inventory"));
	}
