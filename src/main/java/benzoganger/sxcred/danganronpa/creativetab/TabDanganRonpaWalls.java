...
public class TabDanganRonpaWalls extends ElementsBenzogangedSxredDanganronpaMod.ModElement {
	public TabDanganRonpaWalls(ElementsBenzogangedSxredDanganronpaMod instance) {
		super(instance, 2);
	}
